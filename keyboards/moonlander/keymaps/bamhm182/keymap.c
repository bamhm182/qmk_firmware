...
/* QWERTY
 ...
 1 |       |        |        |        |        |        |        |       |        |        |        |        |        |        |        | 1
   |-------+--------+--------+--------+--------+--------+--------|       |--------+--------+--------+--------+--------+--------+--------|
 2 | Esc   |   Q    |   W    |   E    |   R    |   T    |        |       |        |   Y    |   U    |   I    |   O    |   P    |        | 2
   |-------+--------+--------+--------+========+--------+--------|       |--------+--------+========+--------+--------+--------+--------|
 3 | Bksp  |   A    |   S    |   D    |   F    |   G    |        |       |        |   H    |   J    |   K    |   L    |   ; :  | Enter  | 3
   |-------+--------+--------+--------+========+--------+--------'       `--------+--------+========+--------+--------+--------+--------|
...
*/
  [_ADJUST] = LAYOUT_moonlander(
    ...
    _______, _______, _______, MU_NEXT, RGB_MOD, _______,                            _______, _______, _______, _______, _______, _______,
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
  ...
  */
  ...
  [_ADJUST] = {
    ...
    CLR____, CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,          CLR____, CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,
    CLR____, CLR____, CLR_RED, CLR_GRN, CLR_BLU, CLR____, CLR____,          CLR____, CLR____, CLR____, CLR____, CLR____, CLR____, CLR_ORG,
    CLR____, CLR____, CLR____, CLR_GRN, CLR_BLU, CLR____,                            CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,
