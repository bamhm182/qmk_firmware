...
/* Adjust (Lower + Raise)
 ...
 1 |  F1   |  F2    |  F3    |  F4    |  F5    |  F6    |  F7    |        |  F8    |  F9    |  F10   |  F11   |  F12   |  F13   |  F14   | 1
   |-------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
 2 |       |        | ASTog  | MuTogg | RGBTog |        |        |        |        | Last   | Mute   | VolUp  |        |        | Reset  | 2
   |-------+--------+--------+--------+========+--------+--------|        |--------+--------+========+--------+--------+--------+--------|
 3 |       |        |        | MuNext | RGBMod |        |        |        |        | Next   |Paus/Ply| VolDwn |        |        |        | 3
   |-------+--------+--------+--------+========+--------+--------'        `--------+--------+========+--------+--------+--------+--------|
 4 |       |        |        |        |        |        |                          |        |        |        |        |        |        | 4
   |-------+--------+--------+--------+--------+--------'                          `--------+--------+--------+--------+--------+--------|
 5 | CDL   |        |        |        |        | ,--------.                     ,--------.  |        |        |        |        |        | 5
...
*/
  [_ADJUST] = LAYOUT_moonlander(
    ...
    _______, _______, AS_TOGG, MU_TOGG, RGB_TOG, _______, _______,          _______, KC_MPRV, KC_MUTE, KC_VOLU, _______, _______, MK_RST ,
    _______, _______, _______, MU_NEXT, RGB_MOD, _______, _______,          _______, KC_MNXT, KC_MPLY, KC_VOLD, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______,
...
*/
  [_CDL] = LAYOUT_moonlander(
    ...
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, COLEMAK, _______, GAMING , _______,          _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______,   _______,                       _______,    _______, _______, _______, _______, _______,
                                          _______, _______, _______,     _______, _______, _______
  ),
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
  ...
  */
  ...
  [_ADJUST] = {
    ...
    CLR____, CLR____, CLR_RED, CLR_GRN, CLR_BLU, CLR____, CLR____,          CLR____, CLR_BLU, CLR_RED, CLR_GRN, CLR____, CLR____, CLR_PNK,
    CLR____, CLR____, CLR____, CLR_GRN, CLR_BLU, CLR____, CLR____,          CLR____, CLR_BLU, CLR_BLU, CLR_GRN, CLR____, CLR____, CLR____,
    CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,                            CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,
  ...
  [_CDL] = {
    ...
    CLR____, CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,          CLR____, CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,
    CLR____, CLR____, CLR____, CLR_PUR, CLR____, CLR_PUR, CLR____,          CLR____, CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,
    CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,                            CLR____, CLR____, CLR____, CLR____, CLR____, CLR____,
    CLR____, CLR____, CLR____, CLR____, CLR____,   CLR____,                       CLR____,    CLR____, CLR____, CLR____, CLR____, CLR____,
                                          CLR____, CLR____, CLR____,     CLR____, CLR____, CLR____
  },
...
bool rgb_matrix_indicators_user(void) {
  ...
  if (layer == _COLEMAK || layer == _QWERTY || layer == _GAMING) {
